...
<Button className='fixed z-[100000] top-12 left-4 p-0 w-10 h-10' onClick={()=>setOpenFallingStar(prev=>!prev)}><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
